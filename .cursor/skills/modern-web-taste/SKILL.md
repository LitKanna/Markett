...
- Read `DESIGN.md` first — tokens and kill list are locked there (v108 quiet DTC).
- Job: book Fri/Sat Flemington tray pickup.
- Prices: $12 / $23 / $66. Eggs are large · 1.75kg.
- Bind price UI with `[data-price]` / `[data-per]`, never DOM index.
- Preserve booking element IDs.
- Do not revive Pace clone motifs (blue pill logo, floating eggs, orange burst, 4-icon navy bar).
