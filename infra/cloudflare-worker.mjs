...
const DEPLOY_SHA = "4b93c7acca19232165d22f93d347cad44be4cf09";
const UPSTREAMS = [
...
<head>
  ...
  <meta property="og:image" content="https://getyolko.com/assets/tray-studio.jpg?v=130">
  ...
  <link rel="preload" as="image" href="assets/tray-hero.webp?v=130" type="image/webp">
    ...
    "@graph": [
      {
        ...
        "image": "https://getyolko.com/assets/tray-studio.jpg?v=130",
        "priceRange": "$$",
        "address": {
          "@type": "PostalAddress",
...
<body>
      ...
      <div class="wrap hero-stage">
        ...
        <div class="hero-mark" aria-hidden="true">
          <img
            ...
            src="assets/tray-hero.webp?v=130"
            alt=""
            width="1128"
            height="812"
            decoding="async"
          ...
          <video
            ...
            playsinline
            preload="metadata"
            poster="assets/tray-hero.webp?v=130"
            width="1128"
            height="812"
          >
            <source src="assets/tray-hero.mp4?v=130" type="video/mp4">
            <source src="assets/tray-hero.webm?v=130" type="video/webm">
          </video>
        </div>
      </div>
    </section>
      ...
      <div class="wrap order-grid">
        <div class="order-copy">
          ...
          <div class="order-tray">
            <picture>
              <source srcset="assets/tray-closed.webp?v=130" type="image/webp">
              <img src="assets/tray-closed.jpg?v=130" alt="Sealed Pace Farm 30-egg tray with lid closed" width="1200" height="896" loading="lazy" decoding="async">
            </picture>
  ...
  <script src="config.js?v=130"></script>
  ...
  async fetch(request, env) {
    ...
    if (!upstreamResp) {
      return new Response(`Not found (${path}, upstream ${lastStatus})`, {
        status: 404,
        headers: { "Content-Type": "text/plain; charset=utf-8", "X-Yolko-Build": "130" },
      });
    }
