...
const DEPLOY_SHA = "708c70f11291d3e013c60400498a7e37872a6bcf";
const UPSTREAMS = [
...
<head>
  ...
  <meta property="og:image" content="https://getyolko.com/assets/hf_2-hero.jpg?v=105">
  ...
  <link rel="preload" as="image" href="assets/hf_2-cut.webp?v=105" type="image/webp">
    ...
    "@graph": [
      {
        ...
        "image": "https://getyolko.com/assets/hf_2-hero.jpg?v=105",
        "priceRange": "$$",
        "address": {
          "@type": "PostalAddress",
...
<body>
    ...
    <section class="hero">
      <div class="wrap hero-split">
        <div class="hero-copy">
          ...
          <h1>Market eggs.<br><em>Fair price.</em></h1>
          <p class="price-line"><strong class="badge-price">$12</strong><span> / 30 Pace Farm large eggs</span></p>
        ...
        <div class="hero-visual">
          ...
          <picture class="hero-tray">
            <source srcset="assets/hf_2-cut.webp?v=105" type="image/webp">
            <img src="assets/hf_2-hero.jpg?v=105" alt="Pace Farm 30 large eggs tray, 1.75kg" width="1400" height="1048" fetchpriority="high" decoding="async">
          </picture>
        </div>
      </div>
    </section>
      ...
      <div class="wrap order-grid">
        <div class="order-copy">
          ...
          <div class="order-tray">
            <picture>
              <source srcset="assets/hf_2-order.webp?v=105" type="image/webp">
              <img src="assets/hf_2-order.jpg?v=105" alt="Pace Farm 30 large eggs tray" width="800" height="599" loading="lazy" decoding="async">
            </picture>
  ...
  <script src="config.js?v=105"></script>
  ...
  async fetch(request, env) {
    ...
    if (!upstreamResp) {
      ...
      return new Response(`Not found (${path}, upstream ${lastStatus})`, {
        status: 404,
        headers: { "Content-Type": "text/plain; charset=utf-8", "X-Yolko-Build": "105" },
      });
    }
