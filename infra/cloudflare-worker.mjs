...
<head>
  ...
  <meta property="og:image" content="https://getyolko.com/assets/tray-studio.jpg?v=111">
  ...
  <link rel="preload" as="image" href="assets/tray-studio.webp?v=111" type="image/webp">
    ...
    "@graph": [
      {
        ...
        "image": "https://getyolko.com/assets/tray-studio.jpg?v=111",
        "priceRange": "$$",
        "address": {
          "@type": "PostalAddress",
...
<body>
  ...
  <main id="top">
    ...
    <section class="hero">
      <div class="wrap hero-split">
        <div class="hero-copy">
          <h1 class="hero-line">Book ahead. Walk out with eggs.</h1>
          <p class="offer">
            <span class="badge-price">$12</span>
            <span class="offer-rest">for 30 large eggs</span>
          </p>
          <p class="lede">Friday or Saturday pickup at Flemington Markets.</p>
        ...
        <div class="hero-visual">
          <picture class="hero-tray">
            <source srcset="assets/tray-studio.webp?v=111" type="image/webp">
            <img src="assets/tray-studio.jpg?v=111" alt="Pace Farm 30 large eggs tray" width="1536" height="1024" fetchpriority="high" decoding="async">
          </picture>
        </div>
      </div>
    </section>
      ...
      <div class="wrap order-grid">
        <div class="order-copy">
          ...
          <div class="order-tray">
            <picture>
              <source srcset="assets/tray-studio.webp?v=111" type="image/webp">
              <img src="assets/tray-studio.jpg?v=111" alt="Pace Farm 30 large eggs tray" width="1536" height="1024" loading="lazy" decoding="async">
            </picture>
  ...
  <script src="config.js?v=111"></script>
  ...
  async fetch(request, env) {
    ...
    if (!upstreamResp) {
      ...
      return new Response(`Not found (${path}, upstream ${lastStatus})`, {
        status: 404,
        headers: { "Content-Type": "text/plain; charset=utf-8", "X-Yolko-Build": "111" },
      });
    }
