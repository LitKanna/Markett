...
const DEPLOY_SHA = "da9892d9a2ca5aa3c87929120b7c4c89bbd35e4b";
const UPSTREAMS = [
...
<head>
  ...
  <meta property="og:image" content="https://getyolko.com/assets/tray-studio.jpg?v=107">
  ...
  <link rel="preload" as="image" href="assets/tray-studio.webp?v=107" type="image/webp">
    ...
    "@graph": [
      {
        ...
        "image": "https://getyolko.com/assets/tray-studio.jpg?v=107",
        "priceRange": "$$",
        "address": {
          "@type": "PostalAddress",
  ...
  <div class="page">
    ...
    <header class="topbar">
      <div class="wrap topbar-inner">
        <a class="brand" href="#top" aria-label="YOLKO home">
          <span class="brand-badge">YOLKO</span>
        </a>
      ...
      <section class="hero">
        <div class="wrap hero-grid">
          <div class="hero-copy">
            ...
            <p class="lede">Pace Farm trays at Flemington Markets. Book online, pick up Friday or Saturday.</p>
            <div class="hero-actions">
              <a class="btn btn-navy" href="#order">Book now <span aria-hidden="true">→</span></a>
              <a class="btn-text" href="#pickup">
                <span class="play" aria-hidden="true"></span>
                See pickup times
              </a>
            </div>

            <div class="feature-bar" aria-label="Why YOLKO">
              <div class="feat">
                <span class="feat-icon" aria-hidden="true">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M12 3c-2.5 3.5-6 6.2-6 10a6 6 0 0 0 12 0c0-3.8-3.5-6.5-6-10Z"/><path d="M9 14c.5 2 1.5 3 3 3"/></svg>
                </span>
                <div>
                  <strong>Pace Farm</strong>
                  <span id="tray-spec">Large · 1.75kg tray</span>
                </div>
              </div>
              <div class="feat">
                <span class="feat-icon" aria-hidden="true">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><circle cx="12" cy="12" r="4"/><path d="M12 2v2M12 20v2M2 12h2M20 12h2M4.9 4.9l1.4 1.4M17.7 17.7l1.4 1.4M4.9 19.1l1.4-1.4M17.7 6.3l1.4-1.4"/></svg>
                </span>
                <div>
                  <strong>Fri &amp; Sat</strong>
                  <span>Flemington pickup</span>
                </div>
              </div>
              <div class="feat">
                <span class="feat-icon" aria-hidden="true">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M12 21s-7-4.4-7-10a7 7 0 0 1 14 0c0 5.6-7 10-7 10Z"/><circle cx="12" cy="11" r="2.2"/></svg>
                </span>
                <div>
                  <strong>$12 a tray</strong>
                  <span>30 large eggs</span>
                </div>
              </div>
              <div class="feat">
                <span class="feat-icon" aria-hidden="true">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M4 12h4l2-5 3 10 2-5h5"/><path d="M3 19h18"/></svg>
                </span>
                <div>
          ...
          <div class="hero-visual" aria-hidden="true">
            ...
            <img class="float-egg egg-1" src="assets/egg-float-1.webp?v=107" alt="" width="180" height="240" decoding="async">
            <img class="float-egg egg-2" src="assets/egg-float-2.webp?v=107" alt="" width="140" height="190" decoding="async">
            <div class="burst">
              <strong class="badge-price">$12</strong>
              <span>30 eggs</span>
            </div>
          </div>
        </div>
        ...
        <div class="wrap order-grid">
          <div class="order-copy">
            ...
            <div class="order-tray">
              <picture>
                <source srcset="assets/tray-studio.webp?v=107" type="image/webp">
                <img src="assets/tray-studio.jpg?v=107" alt="Pace Farm 30 large eggs tray" width="1536" height="1024" loading="lazy" decoding="async">
              </picture>
    ...
    <footer class="foot">
      <div class="wrap foot-inner">
        ...
        <p class="foot-line">Fresh eggs, every Friday and Saturday.</p>
  ...
  async fetch(request, env) {
    ...
    if (!upstreamResp) {
      ...
      return new Response(`Not found (${path}, upstream ${lastStatus})`, {
        status: 404,
        headers: { "Content-Type": "text/plain; charset=utf-8", "X-Yolko-Build": "107" },
      });
    }
