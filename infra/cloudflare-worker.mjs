...
const DEPLOY_SHA = "1eab512f9f04ea5de67238f8485d89f985834e74";
const UPSTREAMS = [
...
<head>
  ...
  <meta property="og:image" content="https://getyolko.com/assets/tray-studio.jpg?v=117">
  ...
  <link rel="preload" as="image" href="assets/tray-on-page.webp?v=117" type="image/webp">
    ...
    "@graph": [
      {
        ...
        "image": "https://getyolko.com/assets/tray-studio.jpg?v=117",
        "priceRange": "$$",
        "address": {
          "@type": "PostalAddress",
...
<body>
  ...
  <main id="top">
    ...
    <section class="hero">
      <div class="wrap hero-split">
        <div class="hero-copy">
          <p class="eyebrow">Flemington Markets · Fri &amp; Sat</p>
          <h1 class="hero-line">30 large eggs this weekend</h1>
          <p class="offer">
            <span class="badge-price">$12</span>
            <span class="offer-rest">one Pace Farm tray</span>
          </p>
          <p class="lede">Book online. Pick up Friday or Saturday at the stall.</p>
        ...
        <div class="hero-visual">
          <picture class="hero-tray">
            <source srcset="assets/tray-on-page.webp?v=117" type="image/webp">
            <img src="assets/tray-on-page.jpg?v=117" alt="Pace Farm 30 large eggs tray" width="1215" height="779" fetchpriority="high" decoding="async">
          </picture>
        </div>
      </div>
    </section>
      ...
      <div class="wrap order-grid">
        <div class="order-copy">
          ...
          <div class="order-tray">
            <picture>
              <source srcset="assets/tray-on-page.webp?v=117" type="image/webp">
              <img src="assets/tray-on-page.jpg?v=117" alt="Pace Farm 30 large eggs tray" width="1215" height="779" loading="lazy" decoding="async">
            </picture>
  ...
  <script src="config.js?v=117"></script>
  ...
  async fetch(request, env) {
    ...
    if (!upstreamResp) {
      return new Response(`Not found (${path}, upstream ${lastStatus})`, {
        status: 404,
        headers: { "Content-Type": "text/plain; charset=utf-8", "X-Yolko-Build": "117" },
      });
    }
