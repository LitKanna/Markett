...
<head>
  ...
  <meta property="og:image" content="https://getyolko.com/assets/tray-studio.jpg?v=123">
  ...
  <link rel="preload" as="image" href="assets/tray-hero.webp?v=123" type="image/webp">
    ...
    "@graph": [
      {
        ...
        "image": "https://getyolko.com/assets/tray-studio.jpg?v=123",
        "priceRange": "$$",
        "address": {
          "@type": "PostalAddress",
      ...
      <div class="wrap hero-split">
        ...
        <div class="hero-visual">
          <picture class="hero-tray">
            <source srcset="assets/tray-hero.webp?v=123" type="image/webp">
            <img src="assets/tray-hero.jpg?v=123" alt="30 large Pace Farm eggs in a clear tray" width="1392" height="934" fetchpriority="high" decoding="async">
          </picture>
        </div>
      </div>
    </section>
      ...
      <div class="wrap order-grid">
        <div class="order-copy">
          ...
          <div class="order-tray">
            <picture>
              <source srcset="assets/tray-closed.webp?v=123" type="image/webp">
              <img src="assets/tray-closed.jpg?v=123" alt="Sealed Pace Farm 30-egg tray with lid closed" width="900" height="790" loading="lazy" decoding="async">
            </picture>
  ...
  async fetch(request, env) {
    ...
    if (!upstreamResp) {
      return new Response(`Not found (${path}, upstream ${lastStatus})`, {
        status: 404,
        headers: { "Content-Type": "text/plain; charset=utf-8", "X-Yolko-Build": "123" },
      });
    }
