...
const DEPLOY_SHA = "a30d3e4e2334d4425a5432f7b91ac06ed008d8d4";
const UPSTREAMS = [
...
<head>
  ...
  <title>YOLKO | Fresh Eggs $12 · Fri & Sat Pickup at Flemington</title>
  <meta name="description" content="Fair-price Pace Farm eggs at Flemington Markets. 30-egg tray $12, 2 trays $23, full box $66. Book online, pick up Friday or Saturday at Paddy's Markets.">
  ...
  <meta property="og:image" content="https://getyolko.com/assets/tray-studio.jpg?v=127">
  ...
  <link rel="preload" as="image" href="assets/tray-hero.webp?v=127" type="image/webp">
    ...
    "@graph": [
      {
        ...
        "image": "https://getyolko.com/assets/tray-studio.jpg?v=127",
        "priceRange": "$$",
        "address": {
          "@type": "PostalAddress",
...
<body>
  ...
  <a class="skip" href="#order">Skip to booking</a>
  ...
  <header class="topbar">
    <div class="wrap topbar-inner">
      ...
      <a class="btn btn-ink btn-small" href="#order">Book now</a>
    </div>
  </header>
  ...
  <main id="top">
    ...
    <section class="hero">
      <div class="wrap hero-stage">
        <div class="hero-copy">
          <p class="eyebrow">Flemington market mornings</p>
          <h1 class="hero-line">Fresh eggs. Fair price.</h1>
          <p class="offer">
            <span class="badge-price">$12</span>
            <span class="offer-rest">30 large · Pace Farm · 1.75kg</span>
          </p>
          <p class="lede">Book online. Collect Friday or Saturday at Paddy's Markets Flemington.</p>
          <div class="hero-actions">
            <a class="btn btn-ink" href="#order">Book your tray</a>
            <a class="btn btn-line" href="#why">Why YOLKO</a>
          </div>
        </div>

        <div class="hero-mark" aria-hidden="true">
          <picture>
            <source srcset="assets/tray-hero.webp?v=127" type="image/webp">
            <img src="assets/tray-hero.jpg?v=127" alt="" width="1440" height="1038" fetchpriority="high" decoding="async">
          </picture>
        </div>
      </div>
    </section>

    <section id="why" class="values" aria-label="Why YOLKO">
      <div class="wrap">
        <header class="section-head">
          <h2>What we stand for</h2>
          <p>Simple market eggs, sold the honest way — book ahead, fair price, pick up fresh.</p>
        </header>
        <div class="values-row">
          <article class="value">
            <p class="value-kicker">Fair price</p>
            <h3>$12 for 30 large eggs</h3>
            <p>Market-direct trays. Same Pace Farm quality, without supermarket markup.</p>
          </article>
          <article class="value">
            <p class="value-kicker">Book ahead</p>
            <h3>Reserve before they run out</h3>
            <p>Trays sell most weeks. Book online and we hold yours for pickup.</p>
          </article>
          <article class="value">
            <p class="value-kicker">Weekend-fresh</p>
            <h3>Friday &amp; Saturday only</h3>
            <p>Collect when you need them — for the weekend cook, bake, and brunch.</p>
          </article>
        </div>
      </div>
    </section>

    <section class="proof" aria-label="Quick facts">
      <div class="wrap proof-row">
        ...
        <p><strong>Fri &amp; Sat</strong><span>Reserve online, collect at the stall</span></p>
      </div>
    </section>
    ...
    <section id="prices" class="prices">
      <div class="wrap">
        <header class="section-head">
          <h2>Pick a bundle</h2>
          <p>Same fresh eggs. Better unit price when you take more.</p>
        </header>

        <div class="price-bento">
          <article class="price-card featured" data-bundle-card="tray2">
            <p class="flag">Most booked</p>
            <div class="price-card-body">
              <h3>Double up</h3>
              <p class="price-big" data-price="tray2">$23</p>
              <p class="price-per" data-per="tray2">60 eggs · save $1</p>
              <ul>
                <li>Families and bakers</li>
                <li>One pickup, two trays</li>
              </ul>
            </div>
            <a class="btn btn-ink btn-block" href="#order" data-bundle="tray2">Book 2 trays</a>
          </article>

          <div class="price-stack">
            <article class="price-card" data-bundle-card="tray1">
              <div class="price-card-body">
                <h3>Single tray</h3>
                <p class="price-big" data-price="tray1">$12</p>
                <p class="price-per" data-per="tray1">30 eggs · 40&cent; each</p>
              </div>
              <a class="btn btn-line btn-block" href="#order" data-bundle="tray1">Book 1 tray</a>
            </article>
            <article class="price-card" data-bundle-card="box">
              <div class="price-card-body">
                <h3>Full box</h3>
                <p class="price-big" data-price="box">$66</p>
                <p class="price-per" data-per="box">6 trays · 180 eggs</p>
              </div>
      ...
      <div class="wrap pickup-split">
        <div class="pickup-copy">
          ...
          <div class="loc-row">
            ...
            <a class="btn btn-line btn-small" href="https://www.google.com/maps/search/Paddy's+Markets+Flemington+Sydney+Markets" target="_blank" rel="noopener noreferrer">Maps</a>
          </div>
        </div>
        ...
        <aside class="flow">
          <h3>How it works</h3>
          <ol>
            <li><strong>Choose</strong> your bundle and day</li>
            <li><strong>Confirm</strong> by text or WhatsApp</li>
            <li><strong>Pick up</strong> at the market</li>
            <li><strong>Pay</strong> on pickup, or prepay for priority</li>
          </ol>
        </aside>
      </div>
    </section>
      ...
      <div class="wrap order-grid">
        <div class="order-copy">
          ...
          <div class="order-tray">
            <picture>
              <source srcset="assets/tray-closed.webp?v=127" type="image/webp">
              <img src="assets/tray-closed.jpg?v=127" alt="Sealed Pace Farm 30-egg tray with lid closed" width="1200" height="896" loading="lazy" decoding="async">
            </picture>
        ...
        <form id="order-form" class="order-form">
          ...
          <div class="cta-row">
            <button type="submit" class="btn btn-line" id="submit-btn">
              <span id="submit-label">Reserve</span>
            </button>
            <button type="button" class="btn btn-ink" id="buynow-btn">
        ...
        <div class="done-card">
          ...
          <div class="done-detail">
            ...
            <div class="done-actions">
              ...
              <a id="stripe-pay" class="btn btn-ink btn-block" target="_blank" rel="noopener noreferrer" hidden>Pay online now</a>
      ...
      <div class="wrap">
        ...
        <div class="faq-grid">
          ...
          <details>
            ...
            <p id="faq-eggs">Pace Farm large eggs, 30 to a tray (1.75kg). Same brand as the big shops, fairer market price.</p>
          </details>
          <details>
  ...
  <footer class="foot">
    <div class="wrap foot-inner">
      ...
      <p class="foot-line">Fresh eggs. Fair price. Every Friday and Saturday.</p>
      <p class="foot-copy">&copy; 2026 YOLKO</p>
    </div>
  </footer>

  <script src="config.js?v=127"></script>
  ...
  async fetch(request, env) {
    ...
    if (!upstreamResp) {
      return new Response(`Not found (${path}, upstream ${lastStatus})`, {
        status: 404,
        headers: { "Content-Type": "text/plain; charset=utf-8", "X-Yolko-Build": "127" },
      });
    }
