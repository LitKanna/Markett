...
<head>
  ...
  <meta property="og:image" content="https://getyolko.com/assets/tray-studio.jpg?v=131">
  ...
  <link rel="preload" as="image" href="assets/tray-hero.webp?v=131" type="image/webp">
    ...
    "@graph": [
      {
        ...
        "image": "https://getyolko.com/assets/tray-studio.jpg?v=131",
        "priceRange": "$$",
        "address": {
          "@type": "PostalAddress",
...
<body>
      ...
      <div class="wrap hero-stage">
        ...
        <div class="hero-mark" aria-hidden="true">
          <img
            ...
            src="assets/tray-hero.webp?v=131"
            alt=""
            width="1128"
            height="812"
            decoding="async"
          ...
          <video
            ...
            playsinline
            preload="metadata"
            poster="assets/tray-hero.webp?v=131"
            width="1128"
            height="812"
          >
            <source src="assets/tray-hero.mp4?v=131" type="video/mp4">
            <source src="assets/tray-hero.webm?v=131" type="video/webm">
          </video>
        </div>
      </div>
    </section>
      ...
      <div class="wrap order-grid">
        <div class="order-copy">
          ...
          <div class="order-tray">
            <picture>
              <source srcset="assets/tray-closed.webp?v=131" type="image/webp">
              <img src="assets/tray-closed.jpg?v=131" alt="Sealed Pace Farm 30-egg tray with lid closed" width="1200" height="896" loading="lazy" decoding="async">
            </picture>
  ...
  <script src="config.js?v=131"></script>
  ...
  async fetch(request, env) {
    ...
    if (!upstreamResp) {
      return new Response(`Not found (${path}, upstream ${lastStatus})`, {
        status: 404,
        headers: { "Content-Type": "text/plain; charset=utf-8", "X-Yolko-Build": "131" },
      });
    }
