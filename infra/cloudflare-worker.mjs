...
const DEPLOY_SHA = "461696241b6137cde54772e0d0cc7f218358c82a";
const UPSTREAMS = [
...
<head>
  ...
  <meta property="og:image" content="https://getyolko.com/assets/tray-studio.jpg?v=112">
  ...
  <link rel="preload" as="image" href="assets/tray-studio.webp?v=112" type="image/webp">
    ...
    "@graph": [
      {
        ...
        "image": "https://getyolko.com/assets/tray-studio.jpg?v=112",
        "priceRange": "$$",
        "address": {
          "@type": "PostalAddress",
...
<body>
      ...
      <div class="wrap hero-split">
        <div class="hero-copy">
          <h1 class="hero-line">
            ...
            <span class="hero-rest">for a tray of 30 large eggs</span>
          </h1>
        ...
        <div class="hero-visual">
          <picture class="hero-tray">
            <source srcset="assets/tray-studio.webp?v=112" type="image/webp">
            <img src="assets/tray-studio.jpg?v=112" alt="Pace Farm 30 large eggs tray" width="1536" height="1024" fetchpriority="high" decoding="async">
          </picture>
        </div>
      </div>
    </section>
      ...
      <div class="wrap order-grid">
        <div class="order-copy">
          ...
          <div class="order-tray">
            <picture>
              <source srcset="assets/tray-studio.webp?v=112" type="image/webp">
              <img src="assets/tray-studio.jpg?v=112" alt="Pace Farm 30 large eggs tray" width="1536" height="1024" loading="lazy" decoding="async">
            </picture>
  ...
  <script src="config.js?v=112"></script>
