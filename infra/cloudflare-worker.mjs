...
<head>
  ...
  <meta property="og:image" content="https://getyolko.com/assets/tray-studio.jpg?v=106">
  ...
  <link rel="preload" as="image" href="assets/tray-studio.webp?v=106" type="image/webp">
    ...
    "@graph": [
      {
        ...
        "image": "https://getyolko.com/assets/tray-studio.jpg?v=106",
        "priceRange": "$$",
        "address": {
          "@type": "PostalAddress",
...
<body>
      ...
      <div class="wrap hero-split">
        ...
        <div class="hero-visual">
          <picture class="hero-tray">
            <source srcset="assets/tray-studio.webp?v=106" type="image/webp">
            <img src="assets/tray-studio.jpg?v=106" alt="Pace Farm 30 large eggs tray" width="1536" height="1024" fetchpriority="high" decoding="async">
          </picture>
        </div>
      </div>
    </section>
      ...
      <div class="wrap order-grid">
        <div class="order-copy">
          ...
          <div class="order-tray">
            <picture>
              <source srcset="assets/hf_2-order.webp?v=106" type="image/webp">
              <img src="assets/hf_2-order.jpg?v=106" alt="Pace Farm 30 large eggs tray" width="800" height="599" loading="lazy" decoding="async">
            </picture>
  ...
  <script src="config.js?v=106"></script>
  ...
  async fetch(request, env) {
    ...
    if (!upstreamResp) {
      ...
      return new Response(`Not found (${path}, upstream ${lastStatus})`, {
        status: 404,
        headers: { "Content-Type": "text/plain; charset=utf-8", "X-Yolko-Build": "106" },
      });
    }
