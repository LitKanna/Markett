...
const DEPLOY_SHA = "7074ccdf3b7b648909e491d6824d78704d1f6355";
const UPSTREAMS = [
...
<head>
  ...
  <meta property="og:image" content="https://getyolko.com/assets/tray-studio.jpg?v=110">
  ...
  <link rel="preload" as="image" href="assets/tray-studio.webp?v=110" type="image/webp">
    ...
    "@graph": [
      {
        ...
        "image": "https://getyolko.com/assets/tray-studio.jpg?v=110",
        "priceRange": "$$",
        "address": {
          "@type": "PostalAddress",
...
<body>
  ...
  <main id="top">
    ...
    <section class="hero">
      <div class="wrap hero-split">
        <div class="hero-copy">
          <h1 class="hero-line">Fresh eggs for Flemington</h1>
          <p class="offer">
            <span class="badge-price">$12</span>
            <span class="offer-rest">for 30 large eggs</span>
          </p>
          <p class="lede">Book online. Pick up Friday or Saturday at the markets.</p>
        ...
        <div class="hero-visual">
          <picture class="hero-tray">
            <source srcset="assets/tray-studio.webp?v=110" type="image/webp">
            <img src="assets/tray-studio.jpg?v=110" alt="Pace Farm 30 large eggs tray" width="1536" height="1024" fetchpriority="high" decoding="async">
          </picture>
        </div>
      </div>
    </section>
    ...
    <section class="proof" aria-label="Quick facts">
      <div class="wrap proof-row">
        ...
        <p><strong>Fri &amp; Sat</strong><span>Book ahead, walk out with eggs</span></p>
      </div>
    </section>
      ...
      <div class="wrap order-grid">
        <div class="order-copy">
          ...
          <div class="order-tray">
            <picture>
              <source srcset="assets/tray-studio.webp?v=110" type="image/webp">
              <img src="assets/tray-studio.jpg?v=110" alt="Pace Farm 30 large eggs tray" width="1536" height="1024" loading="lazy" decoding="async">
            </picture>
  ...
  <script src="config.js?v=110"></script>
  ...
  async fetch(request, env) {
    ...
    if (!upstreamResp) {
      ...
      return new Response(`Not found (${path}, upstream ${lastStatus})`, {
        status: 404,
        headers: { "Content-Type": "text/plain; charset=utf-8", "X-Yolko-Build": "110" },
      });
    }
