...
<head>
  ...
  <meta property="og:image" content="https://getyolko.com/assets/tray-studio.jpg?v=126">
  ...
  <link rel="preload" as="image" href="assets/tray-hero.webp?v=126" type="image/webp">
    ...
    "@graph": [
      {
        ...
        "image": "https://getyolko.com/assets/tray-studio.jpg?v=126",
        "priceRange": "$$",
        "address": {
          "@type": "PostalAddress",
...
<body>
    ...
    <section class="hero">
      <div class="wrap hero-stage">
        ...
        <div class="hero-mark" aria-hidden="true">
          <picture>
            <source srcset="assets/tray-hero.webp?v=126" type="image/webp">
            <img src="assets/tray-hero.jpg?v=126" alt="" width="1440" height="1038" fetchpriority="high" decoding="async">
          </picture>
        </div>
      </div>
    </section>
      ...
      <div class="wrap order-grid">
        <div class="order-copy">
          ...
          <div class="order-tray">
            <picture>
              <source srcset="assets/tray-closed.webp?v=126" type="image/webp">
              <img src="assets/tray-closed.jpg?v=126" alt="Sealed Pace Farm 30-egg tray with lid closed" width="1200" height="896" loading="lazy" decoding="async">
            </picture>
  ...
  <script src="config.js?v=126"></script>
  ...
  async fetch(request, env) {
    ...
    if (!upstreamResp) {
      return new Response(`Not found (${path}, upstream ${lastStatus})`, {
        status: 404,
        headers: { "Content-Type": "text/plain; charset=utf-8", "X-Yolko-Build": "126" },
      });
    }
