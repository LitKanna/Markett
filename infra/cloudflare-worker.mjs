...
const DEPLOY_SHA = "000bab482735916ff70d7ba9473a2af0214de25f";
const UPSTREAMS = [
...
<head>
  ...
  <meta property="og:image" content="https://getyolko.com/assets/hf_2-hero.jpg?v=101">
  <meta property="og:url" content="https://getyolko.com/">
  <meta name="twitter:card" content="summary_large_image">

  <meta name="theme-color" content="#1a56c9">
  ...
  <link rel="preload" as="image" href="assets/hf_2-cut.webp?v=101" type="image/webp">
    ...
    "@graph": [
      {
        ...
        "image": "https://getyolko.com/assets/hf_2-hero.jpg?v=101",
        "priceRange": "$$",
        "address": {
          "@type": "PostalAddress",
...
<body>
  ...
  <main id="top">
    ...
    <!-- HERO CARD (matches Pace Farm mockup structure) -->
    <section class="hero" aria-label="YOLKO hero">
      <div class="wrap">
        <div class="hero-card">

          <!-- Nav lives INSIDE the white card -->
          <header class="card-nav">
            <a class="brand" href="#top">
              <svg class="brand-mark" viewBox="0 0 32 40" width="28" height="34" aria-hidden="true">
                ...
                <circle cx="16" cy="26" r="6.5" fill="#fff"/>
              </svg>
              <span class="brand-lockup">
                <span class="brand-name">YOLKO</span>
                <span class="brand-sub">Flemington</span>
              </span>
            </a>
            <nav class="card-links" aria-label="Main">
              <a href="#prices">Prices</a>
              <a href="#pickup">Pickup</a>
              <a href="#faq">FAQ</a>
            </nav>
            <a class="btn btn-navy btn-small" href="#order">Book now</a>
          </header>

          <div class="hero-body">
            <div class="hero-copy">
              <p class="eyebrow">Paddy's Markets · Fri &amp; Sat</p>
              <h1>Good eggs.<br>Great price.<br><span class="accent">Every week.</span></h1>
              <p class="lede">30 Pace Farm large eggs for <strong>$12</strong> a tray. Book online, pick up Friday or Saturday at Flemington Markets.</p>

              <div class="hero-actions">
                <a class="btn btn-navy" href="#order">Book your tray <span class="arrow" aria-hidden="true">→</span></a>
                <a class="link-play" href="#pickup">
              ...
              <!-- Dashed arrow toward product -->
              <svg class="dash-arrow" viewBox="0 0 180 70" fill="none" aria-hidden="true">
                <path d="M8 18C48 8 96 6 148 28" stroke="#1a56c9" stroke-width="2.2" stroke-dasharray="5 7" stroke-linecap="round"/>
                <path d="M136 18l18 12-22 4" stroke="#1a56c9" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
            </div>
            ...
            <div class="hero-visual">
              ...
              <span class="float-egg e1" aria-hidden="true"></span>
              <span class="float-egg e2" aria-hidden="true"></span>
              <span class="float-egg e3" aria-hidden="true"></span>
              <span class="float-egg e4" aria-hidden="true"></span>

              <figure class="tray">
                <picture>
                  <source srcset="assets/hf_2-cut.webp?v=101" type="image/webp">
                  <img src="assets/hf_2-hero.jpg?v=101" alt="Pace Farm 30 large eggs tray, 1.75kg" width="1400" height="1048" fetchpriority="high" decoding="async">
                </picture>
              </figure>

              <div class="starburst" aria-hidden="true">
                <strong>$12</strong>
                <span>30 eggs<br>this week</span>
              </div>
            </div>
          </div>

          <!-- Feature bar INSIDE the card (mockup bottom strip) -->
          <div class="feature-bar" role="list">
            <div role="listitem">
              <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.8" aria-hidden="true"><path d="M12 3c-2.2 3.8-6 5.8-6 10a6 6 0 0 0 12 0c0-4.2-3.8-6.2-6-10z"/><path d="M9.5 14.5c.8 1.4 2.2 2 3.5 2"/></svg>
              <div>
            ...
            <div role="listitem">
              <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.8" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3.2 2"/></svg>
              <div>
            ...
            <div role="listitem">
              <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.8" aria-hidden="true"><path d="M12 21s-7-4.4-7-10a7 7 0 1 1 14 0c0 5.6-7 10-7 10z"/><circle cx="12" cy="11" r="2.4"/></svg>
              <div>
            ...
            <div role="listitem">
              <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.8" aria-hidden="true"><path d="M5 12.5l5 5L20 7.5"/></svg>
              <div>
                <strong>Prepay priority</strong>
      ...
      <div class="wrap">
        ...
        <div class="price-grid">
          ...
          <article class="price-card featured">
            ...
            <a class="btn btn-navy btn-block" href="#order" data-bundle="tray2">Book 2 trays</a>
          </article>
    ...
    <section id="pickup" class="pickup">
      <div class="wrap pickup-grid">
        <div class="pickup-copy">
          ...
          <div class="loc-card">
            <svg class="loc-pin" viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 1 1 16 0z"/><circle cx="12" cy="10" r="3"/></svg>
            <div class="loc-text">
        ...
        <div class="order-copy">
          ...
          <div class="order-tray-note">
            <div class="order-tray-photo">
              <picture>
                <source srcset="assets/hf_2-order.webp?v=101" type="image/webp">
                <img src="assets/hf_2-order.jpg?v=101" alt="Pace Farm 30 large eggs tray" width="800" height="599" loading="lazy" decoding="async">
              </picture>
            </div>
        ...
        <form id="order-form" class="order-form">
          ...
          <div class="cta-row">
            <button type="submit" class="btn btn-reserve" id="submit-btn">
              <svg viewBox="0 0 24 24" width="17" height="17" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><rect x="3" y="5" width="18" height="16" rx="3"/><path d="M8 3v4M16 3v4M3 11h18"/></svg>
              <span id="submit-label">Reserve</span>
            </button>
            <button type="button" class="btn btn-navy" id="buynow-btn">
    ...
    <section id="done" class="done" hidden aria-live="polite">
      <div class="wrap">
        <div class="done-card">
          <div class="done-side">
            <svg class="done-art" viewBox="0 0 320 210" role="img" aria-label="Booked egg" width="320" height="210">
              ...
              <circle cx="212" cy="142" r="31" fill="#fff"/>
              <circle cx="212" cy="142" r="26" fill="#1f6b45"/>
              <path d="M200 142l9 9 16-18" stroke="#fff" stroke-width="5.5" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
            </svg>
          ...
          <div class="done-detail">
            ...
            <div class="done-actions">
              ...
              <a id="stripe-pay" class="btn btn-navy btn-block" target="_blank" rel="noopener noreferrer" hidden>Pay online now</a>
  ...
  <script src="config.js?v=101"></script>
  ...
  async fetch(request, env) {
    ...
    if (!upstreamResp) {
      ...
      return new Response(`Not found (${path}, upstream ${lastStatus})`, {
        status: 404,
        headers: { "Content-Type": "text/plain; charset=utf-8", "X-Yolko-Build": "101" },
      });
    }
