# YOLKO Design System — locked (v133)
...
## Signature
Higgsfield **transparent tray cutout** (`assets/tray-cutout.webp`) as a designed hero mark on live page stone — real alpha, no photo rectangle. Soft contact shadow + gentle float. Brand in nav.
...
[Book your tray]
```
Premium rules: intentional 2-line headline, generous vertical rhythm, one CTA, weight 700 not 800, no cramped stacks.
